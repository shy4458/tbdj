...
public abstract class LoadingPager extends FrameLayout {
    ...
    public void initCommonView() {
        //加载中视图
        mLoadingView = View.inflate(BaseApplication.context(), R.layout.fragment_fail, null);
        this.addView(mLoadingView);

        //错误视图
        mErrorView = View.inflate(BaseApplication.context(), R.layout.fragment_error, null);
        this.addView(mErrorView);

        //找到错误视图里面重试按钮,设置点击事件
        mErrorView.findViewById(R.id.tv_error).setOnClickListener(new OnClickListener() {
            @Override
        ...
        //空视图
        mEmptyView = View.inflate(BaseApplication.context(), R.layout.pager_empty, null);
